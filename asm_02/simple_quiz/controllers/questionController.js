...
exports.handleCreateQuestionForm = async (req, res) => {
    try {
        ...
        await axiosInstance.post(`${apiUrl}/questions/api/questions`, data);
...
exports.handleUpdateQuestionForm = async (req, res) => {
    try {
        ...
        await axiosInstance.put(`${apiUrl}/questions/api/questions/${req.params.questionId}`, updateData);
...
exports.deleteQuestionUI = async (req, res) => {
    try {
        await axiosInstance.delete(`${apiUrl}/questions/api/questions/${req.params.questionId}`);
        res.redirect('/questions');
    } catch (err) {
